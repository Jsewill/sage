...
Packaging automatically checks the executable, resources, icons, desktop entry,
and library/symbol resolution inside the GNOME runtime. To rerun those checks:
